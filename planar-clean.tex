...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item $\{u,w\}\subset A$, $v\in B$; or $\{u,w\}\subset B$, $v\in C$.  These cases are ruled out by shadow completeness and the assumption that $uvw$ is an induced path.
        \item $\{u,v,w\}\subseteq B$
        \begin{compactenum}
